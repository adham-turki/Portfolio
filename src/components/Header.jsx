const Header = () => {
    return (
        <>
            <header className="bg-orange-100 fixed top-0 left-0 right-0 z-20 flex items-center w-full justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f4] px-10 py-3">
