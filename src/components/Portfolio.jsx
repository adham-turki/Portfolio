...
export default function Component() {
  ...
  return (
    <div className={`min-h-screen ${darkMode ? 'dark' : ''}`}>
      <Parallax
        blur={{ min: -15, max: 15 }}
        bgImage={darkMode ? "/dark-bg.jpg" : "/light-bg.jpg"}
        ...
        <div className="bg-gradient-to-br from-orange-100 to-pink-200 dark:from-gray-900 dark:to-purple-900 text-gray-800 dark:text-gray-200 transition-colors duration-500">
          ...
          <div className="relative z-10">
            ...
            <main className="container mx-auto px-4 py-10">
                ...
                >
                  <Tilt className="Tilt" options={{ max: 25 }}>
                    <img
                      src={adham}
                      alt="Adham"
                      className="rounded-full w-64 h-64 object-cover border-4 border-orange-500 dark:border-orange-400 shadow-lg Tilt-inner"
                    />
                  </Tilt>
                </motion.div>
                <div>
              ...
              >
                <h2 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-pink-500 dark:from-orange-400 dark:to-pink-400">Skills & Expertise</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {[
                    ...
                    { name:
'Data Structures', level: 'Expert' },
                    { name: 'Algorithms', level: 'Advanced' },
                    { name: 'OOP', level: 'Advanced' },
                    { name: 'OOP Design', level: 'Advanced' },
                  ].map((skill) => (
                    <SkillCard key={skill.name} name={skill.name} level={skill.level} icon={iconMap[skill.name]} />
                  ))}
                </div>
              </motion.section>
              ...
              <motion.section
                ...
                viewport={{ once: true, amount: 0.3 }}
              >
                <h2 className="text-4xl font-bold mb-12 text-center bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-pink-500 dark:from-orange-400 dark:to-pink-400">Featured Projects</h2>
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  transition={{ duration: 0.5 }}
                ...
                >
                  {projects.map((project, index) => (
                    <Tilt key={project._id} className="Tilt" options={{ max: 15 }}>
                      <motion.div
              ...
              >
                ...
                >
                  <h2 className="text-4xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-pink-500 dark:from-orange-400 dark:to-pink-400">
                    Get in Touch
                  </h2>
            ...
            <footer className="bg-gray-800 dark:bg-gray-900 text-white py-8 transition-colors duration-500">
              <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex space-x-4 mt-4 md:mt-0">
                  ...
                  <a href="https://www.facebook.com/profile.php?id=100009753456769" target="_blank" rel="noopener noreferrer">
